...
export class DetalleComponent implements OnInit {
  ...
  movieData: { [key: string]: any } = {
    ...
    // [...otros objetos omitidos por brevedad, pero se colocan igual que en tu JSON original...]
  };
  ...
  ngOnInit(): void {
    ...
    if (this.movieId && this.movieData[this.movieId]) {
  ...
  addToFavorites(): void {
    alert(`${this.data.titulo} agregada a favoritos (esto lo podés guardar en localStorage si querés)`);
  }
